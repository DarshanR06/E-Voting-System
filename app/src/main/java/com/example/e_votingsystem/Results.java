...
public class Results extends AppCompatActivity {
    ...
    private adminadapter2 adminadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list=new ArrayList<>();
        adminadapter = new adminadapter2(this, list);
        recyclerViewCandidate.setAdapter(adminadapter);
        ...
        adminadapter.setOnItemClickListener(new adminadapter2.OnItemClickListener() {
            @Override
...
*/
                ...
                String nameKey = list.get(position).getFullNameCandidate();
                amountOfVote = amountOfVote + 1;
                Toast.makeText(Results.this, "Voted successfully", Toast.LENGTH_SHORT).show();
                dbrefCandidate.child(nameKey).child("countVote").setValue(amountOfVote);
                adminadapter.notifyDataSetChanged();
                list.clear();
